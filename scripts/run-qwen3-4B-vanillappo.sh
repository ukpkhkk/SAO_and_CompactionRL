...
LOG_DIR="${PROJECT_DIR}/qwen3_4b_vanillappo_checkpoints"
EXP_NAME=qwen3-4b-Retool-colocate-vanilla-ppo-new-retool+format
export TENSORBOARD_DIR="${LOG_DIR}/${EXP_NAME}/tensorboards"
